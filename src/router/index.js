...
const activeDeatil = resolve => require(['@/pages/buyCard/activeDeatil'], resolve);
...
const newPage = resolve => require(['@/pages/buyCard/newPage'], resolve);
const Consult = resolve => require(['@/pages/buyCard/consult'], resolve);
const Suitshop = resolve => require(['@/pages/buyCard/suitshop'], resolve);
...
const Runphone = resolve => require(['@/pages/runphone'], resolve);


const Runpc = resolve => require(['@/pages/runpc'], resolve);
...
let router = new Router({
  ...
  routes: [{
      ...
      children: [
        ...
        { path: "activeDeatil", name: "activeDeatil", component: activeDeatil },
        { path: "buysuccess", name: "Buysuccess", component: Buysuccess },
        { path: "submit", name: "Submit", component: Submit },
        { path: "consult", name: "Consult", component: Consult },
        { path: "suitshop", name: "Suitshop", component: Suitshop },
...
// console.log(123456789134545)


// router.beforeEach((to, from, next) => {
//   // console.log(232323232323, from);
//   console.log(3434343434434, to.path);
//   if (to.path == "/quanlist") {
//     next('/confessTicket/quanlist')
//   }
//     if (to.path == "/cardmain") {
//     next('/buyCard')
//   }
