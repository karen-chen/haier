              ...
              <div v-show="item.name=='address'">
                ...
                <div class="item">
                  ...
                  <select class="selectBox" v-model="town">
                    <option v-for="(list, index) in areaData" :key="index" :value="list">{{list.townName}}</option>
                  </select>
                </div>
              </div>
              <div class="item">
