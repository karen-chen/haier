<template>
  <div class="runphone">
    ...
    <div :class="[ shakeBox? 'shake' : '','countBox']" v-show="countBox">
      <div class="title"></div>
      <div class="cycBg">
        <div :class="[ imgshage? 'starcyc' : 'starcyc1']"></div>
    ...
    <div class="rankbox"  v-show="rankbox">
      ...
      <div class="canyu"><span>本次参与<i>{{amount}}</i>人</span></div>
    </div>
    <audio id="voice_ding" src="static/voice/ding.mp3" style="display: none"></audio>
    <audio id="voice_kaka" src="static/voice/sasa.mp3" style="display: none"></audio>
  </div>
</template>
<script>
  ...
  methods: {
    ...
    getRankList() {
      ...
      $.ajax({
        ...
        success: function(data) {
          if (data.ret == 0) {
            _this.ranklistlength = data.rankLen;
             _this.ranklist = data.rank.slice(0, _this.ranklistlength);
          }
        },
      });
    },
  ...
  .countBox {
    ...
    .cycBg {
      ...
      .starcyc {
        ...
        width: 100%;
        height: 100%;
        background: url(../assets/czlImg/handbg1.png) 0 0 no-repeat;
        background-size: 100%;
      }
      .starcyc1 {
        position: absolute;
        ...
        width: 100%;
        height: 100%;
        background: url(../assets/czlImg/handbg2.png) 0 0 no-repeat;
        background-size: 100%;
      }
      .hand {
        position: absolute;
