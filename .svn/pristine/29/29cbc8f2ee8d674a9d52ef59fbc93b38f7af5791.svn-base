...
<!--     <div class="successBtn" @click="showQuanList">查看认筹券包</div>
    <div class="successBtn MemberBtn" @click="showMembershipcard" v-show="successBtn">领取会
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        if (data.ret === "0") {
          ...
          self.description = "<p style='padding-bottom:0.2rem'>" + 

data.card.configBean.description.value.replace(/\n/g, "</p><p style='padding-bottom:0.2rem'>") + "</p>";
